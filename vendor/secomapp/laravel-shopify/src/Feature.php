...
use Carbon\Carbon;
use Secomapp\Exceptions\InvalidPlanFeatureException;
...
class Feature
{
     ...
     * @throws  \Secomapp\Exceptions\InvalidPlanFeatureException
     */
    public function __construct($feature_code)
    {
        ...
        $feature = config('billing.features.'.$feature_code);
    ...
    {
        $features = config('billing.features');
